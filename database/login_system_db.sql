...
(110, 'The Big Picture: On the Origins of Life, Meaning, and the Universe Itself', 'Explores fundamental questions about existence, drawing on physics and philosophy.', 'Sean Carroll', '978-639853449', 2016, 'Philosophy of Science, Cosmology', 'Available', 0x75706c6f6164732f7468652062696720706963747572652e6a7067),
(111, 'The Feynman Lectures on Physics', 'Based on a series of lectures by Nobel laureate Richard Feynman, this three-volume set covers the fundamentals of physics in a captivating and accessible manner, making it a favorite among students and enthusiasts alike.', 'Richard P. Feynman', '978-838819237', 1964, 'Non-fiction, Science, Physics', 'Available', 0x75706c6f6164732f6665796d616e2e6a7067);
...
(14, 'admin', '', '', '', '', '', '$2y$10$iRYPQG5xIqERT5IYCu8Cf.bwb4xZYwkdKav6u2kG3zYlSzCKkXmSu', '2024-02-19 00:01:30', 'admin', 0x496d616765732f696d61676573202837292e706e67),
...
(20, 'arjec', 'arjecdizon99@gmail.com', 'Arjec Jose Dizon', 'Student', '+639158423449', 'Guiwan, Zamboanga city', '$2y$10$bWFe52Y3UEGDdjUXOn8X5uZF2HSu7gtot2pxtCr.2x9S/Zf9HqfyS', '2024-03-04 23:12:13', 'user', 0x496d616765732f7363686f6f6c2d73747564656e742d69636f6e2d31382e706e67),
...
--
ALTER TABLE `borrowed_books`
  MODIFY `borrow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;

--
-- AUTO_INCREMENT for table `return_history`
--
ALTER TABLE `return_history`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;
