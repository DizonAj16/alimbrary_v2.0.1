...
if ($result) {
    ...
    echo "<h3 style='margin-bottom: 20px; text-align: center; color: maroon;' class='fw-bold'>Top Borrowers</h3>"; // Apply red color to the heading and add margin-bottom for spacing
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<li style='margin-bottom: 5px; color: maroon; font-weight:bold; font-size: 18px;'>{$row['username']} - Borrowed {$row['borrow_count']} times</li>"; // Added font-size property
    }
    echo "</ol>";
    echo "</div>";
} else {
