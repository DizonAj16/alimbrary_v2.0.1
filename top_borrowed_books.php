...
if ($result) {
    ...
    echo "<h3 style='color: maroon; margin-bottom: 20px;' class='fw-bold'>Most Popular Books</h3>"; // Apply red color to the heading and add margin-bottom for spacing
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<li style='color: maroon; text-align: start; font-weight:bold;'>{$row['title']} - Borrowed {$row['borrow_count']} times</li>"; // Apply red color to the list items and center the text
    }
    echo "</ol>";
