...
if (isset($_POST["searchText"]) && !empty($_POST["searchText"])) {
    ...
    // Prepare the SQL statement to search by title or genre
    $sql = "SELECT * FROM books WHERE title LIKE ? OR genre LIKE ? ORDER BY book_id DESC";
    ...
    // Execute the default SQL query to fetch all books
