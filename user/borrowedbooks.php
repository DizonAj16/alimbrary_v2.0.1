...
?>
    ...
    <body class="d-flex flex-column min-vh-100">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            if ($now > $return_time) {
                                                echo "<button class='btn btn-danger btn-sm text-light fw-bold' onclick='returnConfirmation($borrow_id)'>Return Book</button>";
                                            } else {
                                                echo "<button class='btn btn-danger btn-sm text-light fw-bold' onclick='returnConfirmation($borrow_id)'>Return Book</button>";
                                            }
                                            echo "</td>";
        ...
        <div id="returnConfirmationModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="returnConfirmationModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="returnForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            <input type="hidden" id="borrowIdInput" name="borrow_id">
        ...
        <script>
            ...
            function returnConfirmation(borrowId) {
