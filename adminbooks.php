            ...
            if ($result = mysqli_query($conn, $sql)) {
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<a href="adminviewbook.php?book_id=' . $row['book_id'] . '" class="btn btn-dark rounded-circle" title="View Book" data-toggle="tooltip"><span class="fa fa-eye fa-lg"></span></a>';
                        echo '<a href="updatebook.php?book_id=' . $row['book_id'] . '" class="btn btn-info text-light rounded-circle" title="Update Book" data-toggle="tooltip"><span class="fa fa-pencil fa-lg"></span></a>';
